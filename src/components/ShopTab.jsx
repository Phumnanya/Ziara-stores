        ...
        <>
            <Tabs align="center" isManual variant='unstyled' defaultIndex={1}>
                ...
                <TabPanels>
                    ...
                    <Flex flexDir={"row"} justifyContent={"space-between"} alignItems={"center"} w={"95%"}>
                        <Box h={"fit-content"} w={"30%"}>
                            <Image boxSize='sm' src='/img/dom-hill-nimElTcTNyY-unsplash.jpg' objectFit={"cover"}
                        ...
                        <Box h={"fit-content"} w={"30%"}>
                            <Image boxSize='sm' src='/img/alexanderafan-68EiF7-sU7w-unsplash.jpg' objectFit={"cover"}
                        ...
                        <Box h={"fit-content"} w={"30%"}>
                            <Image boxSize='sm' src='/img/darko-mitev-c5t_j1zlk1Y-unsplash.jpg' objectFit={"cover"}
