import { Tabs, TabList, TabPanels, Tab, TabPanel, Text, VStack, Divider, Heading } from "@chakra-ui/react";

function Press() {
  return (
    <>
    <Tabs isFitted variant="unstyled" isManual display="flex" flexDirection="column-reverse" 
    align="center" mt={"1em"} p={{ base: "10px", md: "20px" }} defaultIndex={1} isLazy>
      <TabList color={"gray.500"}>
        <Tab _selected={{color: "black"}} isLazy>
          <VStack>
      ...
      <TabPanels pb={"2em"}>
        <TabPanel isLazy>
        <VStack>
          <Heading fontSize={{ base: "sm", md: "xl" }} color={"gray.500"} fontFamily={"serif"}>IN THE PRESS</Heading>
          <Text fontSize={{ base: "md", md: "xl" }} fontFamily={"verdana"} textAlign={"center"}>
