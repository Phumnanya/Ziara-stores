...
import { Flex, Box, Text, VStack, Button, Heading, Divider, Card, CardHeader, CardBody, Avatar } from "@chakra-ui/react";
        ...
        <>
            <Box bgColor={"gray.100"} w={"95%"} h={"fit-content"} fontFamily={"verdana"} p={"20px"} m={"1em auto"} boxSizing={"border-box"}>
                <Flex flexDir={"row"} justifyContent={"space-between"} alignItems={"center"} m={"auto"} pb={"10px"}>
                    ...
                    <Button color={"white"} bgColor={"black"} size={{ base: "sm", md: "md" }}>
                    VIEW ALL
                    </Button>
                </Flex>
                ...
                <Flex flexDir={"row"} justifyContent={"center"} alignItems={"center"} m={"auto"} flexWrap={"wrap"}>
                    <Card maxW='md' p={"5px"} boxSizing={"border-box"} m={"10px auto"}>
                        <CardHeader>
                            ...
                            <Flex flex='1' gap='4' alignItems='center' flexWrap='wrap'>
                                <Avatar name='Jennifer Saunders' src='https://ik.imagekit.io/fvrl067t2/ziara/aiony-haust-3TLl_97HNJo-unsplash.jpg?updatedAt=1755611318317' />
                    ...
                    <Card maxW='md' p={"5px"} boxSizing={"border-box"} m={"10px auto"}>
                        <CardHeader>
                            <Flex spacing='4'>
                            <Flex flex='1' gap='4' alignItems='center' flexWrap='wrap'>
                                <Avatar name='Alana Drexel' src='https://ik.imagekit.io/fvrl067t2/ziara/raamin-ka-uR51HXLO7G0-unsplash.jpg?updatedAt=1755611616340' />
